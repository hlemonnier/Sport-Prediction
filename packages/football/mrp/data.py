...
from .constants import (
    ...
    TIMEZONE_COLUMNS,
    VENUE_COLUMNS,
    VENUE_LATITUDE_COLUMNS,
    VENUE_LONGITUDE_COLUMNS,
)
from .utils import (
    canonical_team_id,
...
def _parse_match_row(row: dict[str, Any], default_match_id_prefix: str, index: int) -> MatchRecord | None:
    ...
    venue_name = str(venue_raw).strip() if venue_raw is not None and str(venue_raw).strip() else None
    venue_latitude = parse_float(first_non_empty(row, VENUE_LATITUDE_COLUMNS))
    venue_longitude = parse_float(first_non_empty(row, VENUE_LONGITUDE_COLUMNS))
...
def _as_fixture(match: MatchRecord) -> FixtureRecord:
    return FixtureRecord(
        ...
        venue_latitude=match.venue_latitude,
        venue_longitude=match.venue_longitude,
