...
class F1StateReducer:
    ...
    def _apply_session(self, event: F1Event) -> str:
        ...
        session_info = {
            ...
            "event_name": _first_text(payload, "event_name", "meeting_name"),
            "fastf1_event_name": _first_text(payload, "fastf1_event_name", "event_name", "meeting_name"),
            "circuit_short_name": _first_text(payload, "circuit_short_name", "circuit_name"),
            "country_name": _first_text(payload, "country_name"),
